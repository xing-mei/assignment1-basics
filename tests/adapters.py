...
def run_embedding(
    ...
    """
    embedding = cs336_basics.modules.Embedding(vocab_size, d_model)
    embedding.embedding_table.data = weights
...
def run_transformer_block(
    ...
    """
    transformer_block = cs336_basics.modules.TransformerBlock(d_model, num_heads, d_ff, max_seq_len, theta)
    transformer_block.attn.qkv_proj.w.data = torch.cat([weights['attn.q_proj.weight'], weights['attn.k_proj.weight'], weights['attn.v_proj.weight']], dim=0)
...
def run_rmsnorm(
    ...
    """
    rmsnorm = cs336_basics.modules.RMSNorm(d_model, eps)
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    return cs336_basics.modules.SiLU(in_features)
...
def run_cross_entropy(
    ...
    """
    return cs336_basics.modules.cross_entropy(inputs=inputs, targets=targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    cs336_basics.optimizer.gradient_clipping(parameters, max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    return cs336_basics.optimizer.AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    return cs336_basics.optimizer.lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def get_tokenizer(
    ...
    """
    return cs336_basics.bpe.Tokenizer(vocab, merges, special_tokens)
